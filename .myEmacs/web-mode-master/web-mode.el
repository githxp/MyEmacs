...
(defface web-mode-html-tag-face
  '((((class color) (min-colors 88) (background dark))  :foreground "#FFF33C")
    (((class color) (min-colors 88) (background light)) :foreground "#FFF33C")
    (((class color) (min-colors 16) (background dark))  :foreground "#FFF33C")
    (((class color) (min-colors 16) (background light)) :foreground "#FFF33C")
    (((class color) (min-colors 8))                     :foreground "#FFF33C")
...
(defface web-mode-html-attr-name-face
  '((((class color) (min-colors 88) (background dark))  :foreground "#8583FF")
    (((class color) (min-colors 88) (background light)) :foreground "#8583FF")
    (((class color) (min-colors 16) (background dark))  :foreground "#8583FF")
    (((class color) (min-colors 16) (background light)) :foreground "#8583FF")
    (((class color) (min-colors 8))                     :foreground "#8583FF")
    (((type tty) (class mono))                          :inverse-video t)
    (t                                                  :foreground "#8583FF"))
